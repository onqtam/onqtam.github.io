...
excerpt: "A complete guide to applying the techniques + a few tips in a sorted order"
---
...
- use [doctest](https://github.com/onqtam/doctest/) for unit tests - [benchmarks](https://github.com/onqtam/doctest/blob/master/doc/markdown/benchmarks.md)
    - migrating from [googletest](https://github.com/onqtam/doctest/blob/master/doc/markdown/faq.md#how-is-doctest-different-from-google-test) or [Catch2](https://github.com/onqtam/doctest/blob/master/doc/markdown/faq.md#how-is-doctest-different-from-catch)
